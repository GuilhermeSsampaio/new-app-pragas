//convertendo o conteudo do editor do strapi para html
export const ConversorHtml = ({ data }) => {
  ...
  return <div dangerouslySetInnerHTML={{ __html: convertToHTML(data) }} />;
};
